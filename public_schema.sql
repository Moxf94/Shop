...
ALTER TABLE public.products_property
    OWNER TO postgres;
...
ALTER TABLE public.products_type
    OWNER TO postgres;
...
ALTER TABLE public.property_type_product_type
    OWNER TO postgres;
...
ALTER TABLE ONLY public.products
    ALTER COLUMN id SET DEFAULT nextval('public.pc_components_component_id_seq'::regclass);
...
ALTER TABLE ONLY public.products_property
    ALTER COLUMN id SET DEFAULT nextval('public.products_property_id_seq'::regclass);
...
ALTER TABLE ONLY public.products_type
    ALTER COLUMN id SET DEFAULT nextval('public.products_type_id_seq'::regclass);
...
ALTER TABLE ONLY public.property_type
    ALTER COLUMN id SET DEFAULT nextval('public.property_type_id_seq'::regclass);
...
ALTER TABLE ONLY public.property_type_product_type
    ALTER COLUMN id SET DEFAULT nextval('public.property_type_product_type_id_seq'::regclass);
...
COPY public.property_type_product_type (id, product_type, property_type_id) FROM stdin;
\.
